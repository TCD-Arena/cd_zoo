...
# These are direct copies of the implementations found in:
# https://github.com/jakobrunge/neurips2020/blob/main/svarfci.py
# https://github.com/jakobrunge/neurips2020/blob/main/svarrfci.py
class SVARFCI():
    r"""
